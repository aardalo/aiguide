...
export default function MapContextMenu({ x, y, onSearchNearby, onSearchPark4Night, onSearchTripadvisor, tripadvisorEnabled, onSearchFoursquare, foursquareEnabled, onAddPoi, selectedDayLabel, onClose }: Props) {
